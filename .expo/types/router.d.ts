...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(modals)` | `/(onboarding)` | `/(tabs)` | `/..\src\hooks\useIndexingStatus` | `/_sitemap` | `/about` | `/analyze` | `/folders` | `/help` | `/photo-viewer` | `/plans` | `/profile` | `/recent` | `/search` | `/settings`;
